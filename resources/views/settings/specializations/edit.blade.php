...
@section('title', 'Edit Specialization - Settings')
        ...
        <div class="col-12">
            <div class="card card-primary card-outline mb-4">
                <div class="card-header">
                    <h3 class="card-title">Edit Specialization: {{ $specialization->name }}</h3>
                </div>
                <form action="{{ route('settings.specializations.update', $specialization) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="mb-3">
