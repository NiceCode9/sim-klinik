...
@section('title', 'Create Drug - Settings')

@section('page-title', 'Create Drug')
        ...
        <div class="col-12">
            <div class="card card-primary card-outline mb-4">
                <div class="card-header">
                    <h3 class="card-title">Create New Drug</h3>
                </div>
                <form action="{{ route('settings.drugs.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="category" id="category" class="form-select @error('category') is-invalid @enderror" required>
                                        ...
                                        <option value="Narkotika" {{ old('category') == 'Narkotika' ? 'selected' : '' }}>Narkotika</option>
                                        <option value="Generik" {{ old('category') == 'Generik' ? 'selected' : '' }}>Generik</option>
                                    </select>
                                    @error('category')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="unit" id="unit" class="form-select @error('unit') is-invalid @enderror" required>
                                        ...
                                        <option value="injeksi" {{ old('unit') == 'injeksi' ? 'selected' : '' }}>Injeksi</option>
                                        <option value="lain" {{ old('unit') == 'lain' ? 'selected' : '' }}>Lain</option>
                                    </select>
                                    @error('unit')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="pricing_type" id="pricing_type" class="form-select @error('pricing_type') is-invalid @enderror" required>
                                        ...
                                        @foreach (App\Enums\PricingType::cases() as $type)
                                            <option value="{{ $type->value }}" {{ old('pricing_type') == $type->value ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="price_value" id="price_value" class="form-control @error('price_value') is-invalid @enderror" value="{{ old('price_value') }}" step="0.01" required>
                                    @error('price_value')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="minimum_stock" id="minimum_stock" class="form-control @error('minimum_stock') is-invalid @enderror" value="{{ old('minimum_stock', 0) }}" step="0.01">
                                    @error('minimum_stock')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-check mt-4">
                                        <input type="checkbox" name="is_fractional" id="is_fractional" class="form-check-input @error('is_fractional') is-invalid @enderror" value="1" {{ old('is_fractional') ? 'checked' : '' }}>
